...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `вεм vιη∂σ(α) @${num.split('@')[0]}\ѕє αtєntє αѕ rєgrαѕ nασ ѕєjα ghσѕt σu ѕєrα rєmσvídσ*${mdata.subject}* єѕpєrσ quє vσcє gσѕtє gσ grupσ💫🚶🏽‍♂️`
				...
				teks = `jα ѕαíu dσ grupσ nєm єѕpєrσu єu chαmαr um uвєr 😩💔,bye bye🥳 @${num.split('@')[0]} 🖐🏻tchαu вσα ѕσrtє pσr αí ²`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["5522999982383@s.whatsapp.net"] 
            ...
            break
                ...
                if (getLevelingLevel(sender) < ahb ) return reply(ind.reglevelahb(command, pushname, getLevelingLevel, sender, ahb))
                 ...
                 if (getLevelingLevel(sender) < ahe ) return reply(ind.reglevelahe(command, pushname, getLevelingLevel, sender, ahe))
					...
					var gbl1 = gh.split("|")[0];
					var gbl2 = gh.split("|")[1];
					if (args.length < 1) return reply('Texto em falta')
					reply(ind.wait())
        ...
        /*        case 'kickme':
          *      if (isGroupAdmins) return reply(`maaf ${pushname} saya tidak bisa mengeluarkan admin`)
           ...
           *     await client.groupRemove(groupId, sender)
                ...
                if (!isRegistered) return reply(ind.noregis())
                if (getLevelingLevel(sender) < ahb ) return reply(ind.reglevelahb(command, pushname, getLevelingLevel, sender, ahb))
					const trut =['Você já gostou de alguém? quanto tempo? ',' Se possível ou se você quiser, diga/luar gc siapa yang akan kamu jadikan sahabat?(boleh beda/sma jenis)','apa ketakutan terbesar kamu?','pernah suka sama orang dan merasa orang itu suka sama kamu juga?','Siapa nama mantan pacar teman mu yang pernah kamu sukai diam diam?','pernah gak nyuri uang nyokap atau bokap? Alesanya?','hal yang bikin seneng pas lu lagi sedih apa','pernah cinta bertepuk sebelah tangan? kalo pernah sama siapa? rasanya gimana brou?','pernah jadi selingkuhan orang?','hal yang paling ditakutin','siapa orang yang paling berpengaruh kepada kehidupanmu','hal membanggakan apa yang kamu dapatkan di tahun ini','siapa orang yang bisa membuatmu sange','siapa orang yang pernah buatmu sange','(bgi yg muslim) pernah ga solat seharian?','Siapa yang paling mendekati tipe pasangan idealmu di sini','suka mabar(main bareng)sama siapa?','pernah nolak orang? alasannya kenapa?','Sebutkan kejadian yang bikin kamu sakit hati yang masih di inget','pencapaian yang udah didapet apa aja ditahun ini?','kebiasaan terburuk lo pas di sekolah apa?']
                ...
                if (getLevelingLevel(sender) < ahc ) return reply(ind.reglevelahc(command, pushname, getLevelingLevel, sender, ahc))
					if (args.length < 1) return reply('Insira a Url')
					teks = body.slice(7)
					reply(ind.wait())
			...
			if (getLevelingLevel(sender) < ahd ) return reply(ind.reglevelahd(command, pushname, getLevelingLevel, sender, ahd))
				...
				if (getLevelingLevel(sender) < ahb ) return reply(ind.reglevelahb(command, pushname, getLevelingLevel, sender, ahb))
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply('𝗘𝗻𝘃𝗶𝗲 𝗳𝗼𝘁𝗼𝘀 𝗰𝗼𝗺 𝗰𝗲𝗽çã𝗼 ${prefix}𝗼𝗰𝗿')
					}
					break
				case 'stiker': 
				case 'sticker':
				case 's':
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply(`Envie fotos com legendas ${prefix}sticker marque o gif/ou envie`)
					}
					break
				case 'tts':
				if (!isRegistered) return reply(ind.noregis())
				if (getLevelingLevel(sender) < ahb ) return reply(ind.reglevelahb(command, pushname, getLevelingLevel, sender, ahb))
					...
					rano = getRandom('.ogg')
					dtt.length > 300
					? reply('O texto representa bambang😤')
				...
				case 'setprefix':
					...
					prefix = args[0]
					reply(`𝗢 𝗽𝗿𝗲𝗳𝗶𝘅𝗼 𝗳𝗼𝗶 𝗮𝗹𝘁𝗲𝗿𝗮𝗱𝗼 𝗰𝗼𝗺 𝘀𝘂𝗰𝗲𝘀𝘀𝗼 𝗽𝗮𝗿𝗮: ${prefix}`)
					break 
				case 'hilih': 
				if (!isRegistered) return reply(ind.noregis())
				if (getLevelingLevel(sender) < ahc ) return reply(ind.reglevel(command, pushname, getLevelingLevel, sender, ahc))
					if (args.length < 1) return reply('amo o textoh^_^!!!')
				...
				if (getLevelingLevel(sender) < ahb ) return reply(ind.reglevelahb(command, pushname, getLevelingLevel, sender, ahb))
					try {
						...
						reply('[𝗘𝗥𝗥𝗢] ᴘᴏssíᴠᴇʟ ɴᴏᴍᴇ ᴅᴇ ᴜsᴜáʀɪᴏ ɪɴᴠáʟɪᴅᴏ')
					}
					break
                 case 'linkgc':
				    if (!isGroup) return reply(ind.groupo())
				...
				case 'clearall':
				 ...
				 client.chatRead (from)
					...
					client.sendMessage(from, `𝙋𝙚𝙙𝙞𝙙𝙤 𝙍𝙚𝙘𝙚𝙗𝙞𝙙𝙤 𝙂𝙧𝙪𝙥𝙤 𝘼𝙗𝙚𝙧𝙩𝙤 ${body.slice(9)}@c.us`, text)
				break
				case 'leave': 
				if (!isGroup) return reply(ind.groupo())
					if (!isOwner) return reply(ind.ownerb())
				await reply(dari, 'Adeus').then(() => client.leaveGroup(groupId))
                    break
				case 'bc': 
					if (!isOwner) return reply(ind.ownerb()) 
			   	...
			   	case 'setpp': 
                       ...
                       media = await client.downloadAndSaveMediaMessage(mek)
                        ...
                        reply('ᴀʟᴛᴇʀᴀʀ ᴄᴏᴍ sᴜᴄᴇssᴏ ᴏ íᴄᴏɴᴇ ᴅᴏ ɢʀᴜᴘᴏ')
                break						
				case 'add':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
					...
					if (args[0] === 'buka') {
						...
						reply(`𝗚𝗿𝘂𝗽𝗼 𝗙𝗲𝗰𝗵𝗮𝗱𝗼 𝗰𝗼𝗺 𝗦𝘂𝗰𝗲𝘀𝘀𝗼 l`)
            ...
            case 'creator':
            if (getLevelingLevel(sender) < ahf ) return reply(ind.reglevelahf(command, pushname, getLevelingLevel, sender, ahf))
                  client.sendMessage(from, {displayname: "Jeff", vcad: vcrd}, MessageType.contact, { quoted: mek})
       client.sendMessage(from, 'Este numero esta desativado ku >_<, se ligar pro bot leva blocku',MessageType.text, { quoted: mek} )
           break    
           case 'setname':
                if (!isGroup) return reply(ind.groupo())
			    if (!isGroupAdmins) return reply(ind.admin())
                ...
                client.sendMessage(from, 'Successo, Mudou Descricao do Grupo', text, {quoted: mek})
                break
           case 'demote':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
					...
					if (mentioned.length > 1) {
						...
						for (let _ of mentioned) {
							teks += `𝘽𝙚𝙢 𝙖𝙩𝙚𝙣𝙙𝙞𝙙𝙤??𝙀𝙨𝙩𝙚 𝙖𝙙𝙢𝙞𝙣𝙞𝙨𝙩𝙧𝙖𝙙𝙤𝙧 𝙛𝙤𝙞 𝙧𝙚𝙗𝙖𝙞𝙭𝙖𝙙𝙤 𝙘𝙤𝙢𝙤 𝙢𝙚𝙢𝙗𝙧𝙤🏃 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					} else {
						mentions(`vacilou @${mentioned[0].split('@')[0]} perdeu a administracao do GRUPO sem choro 👋😃🏃`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
				case 'promote':
					...
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `𝙋𝙖𝙧𝙖𝙗𝙚𝙣𝙨🥳 𝙑𝙤𝙘ê é 𝙥𝙧𝙤𝙢𝙤𝙫𝙞𝙙𝙤 𝙖 𝙖𝙙𝙢𝙞𝙣𝙞𝙨𝙩𝙧𝙖𝙙𝙤𝙧 𝙙𝙚 𝙜𝙧𝙪𝙥𝙤(+_+) :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					} else {
						mentions(`pαrαвénѕ🥳 @${mentioned[0].split('@')[0]} vσcê αgσrα é um αdєmírσ dєѕtα jσѕѕα👮?? (+_+)`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break	
			     	case 'kick':
					...
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `vαzα dαquí ѕαtαnαѕ 👺 , rєmσvídσ cσm ѕucєѕѕσ 🤳🏼🏃 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupRemove(from, mentioned)
					} else {
						mentions(`ᴀɢᴏʀᴀ sᴇɢᴜʀᴀ ᴇsᴛá ᴄʜᴜᴛᴀᴅᴏ 😎 ᴋɪᴄᴀᴅᴏ @${mentioned[0].split('@')[0]} 🏃`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmin':
					if (!isGroup) return reply(ind.groupo())
					teks = `ʟɪsᴛᴀ ᴅᴏs ᴀᴅᴇᴍɪʀᴏ ᴅᴏ ɢʀᴜᴘᴏ*${groupMetadata.subject}*\n𝗧𝗼𝘁𝗮𝗹 : ${groupAdmins.length}\n\n`
					no = 0
				...
				if (!isRegistered) return reply(ind.noregis())
				if (getLevelingLevel(sender) < ahb ) return reply(ind.reglevelahb(command, pushname, getLevelingLevel, sender, ahb))
					if (!isQuotedSticker) return reply('rєѕpσndα σu mαrquє cσm ѕtíckєr ,dє ímαgєm !')
					reply(ind.wait())
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '*Esta ai*?? *OK* '})
						fs.unlinkSync(ran)
					})
					break
                 case 'simi':
				...
				case 'simih':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
					if (args.length < 1) return reply('Ok :𝘃')
					if (Number(args[0]) === 1) {
						if (isSimi) return reply('αtívαdσ  !!!')
						samih.push(from)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('❬ 𝙎𝙪𝙘𝙚𝙨𝙨𝙤 ❭ 𝘼𝙩𝙞𝙫𝙚 𝙤 𝙧𝙚𝙘𝙪𝙧𝙨𝙤 𝙨𝙞𝙢𝙞 𝙣𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤')
					} else if (Number(args[0]) === 0) {
						samih.splice(from, 1)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('❬ 𝙎𝙪𝙘𝙚𝙨𝙨𝙤 ❭ 𝘿𝙚𝙨𝙖𝙩𝙞𝙫𝙚 𝙤 𝙧𝙚𝙘𝙪𝙧𝙨𝙤 𝙨𝙞𝙢𝙞 𝙣𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤')
					} else {
				...
				case 'nsfw':
					...
					if (Number(args[0]) === 1) {
						...
						reply('❬ 𝙎𝙪𝙘𝙚𝙨𝙨𝙤 ❭ 𝙃𝙖𝙗𝙞𝙡𝙞𝙩𝙚 𝙤 𝙧𝙚𝙘𝙪𝙧𝙨𝙤 𝙣𝙨𝙛𝙬 𝙣𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤 𝙙𝙚 𝙜𝙧𝙪𝙥𝙤')
					} else if (Number(args[0]) === 0) {
						nsfw.splice(from, 1)
						fs.writeFileSync('./src/nsfw.json', JSON.stringify(nsfw))
						reply('❬ 𝙎𝙪𝙘𝙚𝙨𝙨𝙤 ❭ 𝘿𝙚𝙨𝙖𝙩𝙞𝙫𝙚 𝙤 𝙧𝙚𝙘𝙪𝙧𝙨𝙤 𝙣𝙨𝙛𝙬 𝙣𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤')
					} else {
						reply(' *Digite o comando 1 para ativar, 0 para desativar* \n𝗰𝗼𝗻𝘁𝗼𝗵: 𝗻𝘀𝗳𝘄 𝟭')
					}
					break
            ...
            break
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('❬ 𝙎𝙪𝙘𝙚𝙨𝙨𝙤 ❭ 𝘼𝙩𝙞𝙫𝙚 𝙤 𝙧𝙚𝙘𝙪𝙧𝙨𝙤 𝙙𝙚 𝙗𝙤𝙖𝙨-𝙫𝙞𝙣𝙙𝙖𝙨 / 𝙀 𝙎𝙖𝙞𝙙𝙖 𝙣𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, 1)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('❬ 𝙎𝙪𝙘𝙚𝙨𝙨𝙤 ❭ 𝘿𝙚𝙨𝙡𝙞𝙜𝙖𝙧 𝙤 𝙧𝙚𝙘𝙪𝙧𝙨𝙤 𝙙𝙚 𝙗𝙤𝙖𝙨-𝙫𝙞𝙣𝙙𝙖𝙨 / 𝙀 𝙎𝙖𝙞𝙙𝙖 𝙣𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤')
					} else {
